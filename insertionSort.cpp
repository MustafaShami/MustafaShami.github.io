...
void insertionSort(ItemType theArray[], int n)
{
    ...
    for(int unsorted = 1; unsorted < n; unsorted++)
    {
        ...
        // Find the right position (loc) in theArray[0...unsorted] for theArray[unsorted], which is the first entry
                                                        //   in the unsorted region; shift, if necessary, to make room
